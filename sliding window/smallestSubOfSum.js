...
/* 
Approach:
receive array of nums and a target sum

init minLength, start, sum

if sum is equal or greater than target sum AND current length is less than minLength replace minLength
